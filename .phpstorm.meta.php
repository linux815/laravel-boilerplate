    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'App\Contracts\CategoryRepositoryInterface' => \App\Domain\Category\Repository\CategoryRepository::class,
            'App\Contracts\CategoryServiceInterface' => \App\Domain\Category\Services\CategoryService::class,
            'App\Contracts\CommentRepositoryInterface' => \App\Domain\Comment\Repository\CommentRepository::class,
            'App\Contracts\CommentServiceInterface' => \App\Domain\Comment\Services\CommentService::class,
    ...
    override(\config(), map([
            ...
            'platform.prefix' => 'string',
            'platform.middleware.public' => 'array',
            'platform.middleware.private' => 'array',
            'platform.guard' => 'string',
            'platform.auth' => 'boolean',
            'platform.index' => 'string',
            'platform.profile' => 'string',
            'platform.resource.stylesheets' => 'array',
            'platform.resource.scripts' => 'array',
            'platform.vite' => 'array',
            'platform.template.header' => 'string',
            'platform.template.footer' => 'string',
            'platform.attachment.disk' => 'string',
            'platform.attachment.generator' => 'string',
            'platform.icons.bs' => 'string',
            'platform.notifications.enabled' => 'boolean',
            'platform.notifications.interval' => 'integer',
            'platform.search' => 'array',
            'platform.turbo.cache' => 'boolean',
            'platform.fallback' => 'boolean',
            'platform.workspace' => 'string',
            'platform.prevents_abandonment' => 'boolean',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','platform.domain','platform.prefix',
'platform.middleware.public','platform.middleware.private','platform.guard','platform.auth','platform.index',
'platform.profile','platform.resource.stylesheets','platform.resource.scripts','platform.vite','platform.template.header',
'platform.template.footer','platform.attachment.disk','platform.attachment.generator','platform.icons.bs','platform.notifications.enabled',
'platform.notifications.interval','platform.search','platform.turbo.cache','platform.fallback','platform.workspace',
'platform.prevents_abandonment','platform.provider','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'view.compiled','concurrency.default','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist',
'inertia.testing.page_paths','inertia.testing.page_extensions','scout.driver','scout.prefix','scout.queue',
...
'current-user-photo.destroy','current-user.destroy','sanctum.csrf-cookie','telescope','platform.index','platform.search','platform.async',
'platform.async.listener','platform.systems.files.upload','platform.systems.files.media','platform.systems.files.sort','platform.systems.files.destroy',
'platform.systems.files.update','platform.systems.relation','platform.systems.sorting','platform.notifications','platform.api.notifications',
'platform.','platform.login','platform.login.auth','platform.login.lock','platform.',
'platform.switch.logout','platform.logout','platform.main','platform.profile','platform.systems.users.edit',
'platform.systems.users.create','platform.systems.users','platform.systems.roles.edit','platform.systems.roles.create','platform.systems.roles',
'platform.article.edit','platform.article.list','platform.category.edit','platform.category.list','platform.comment.edit',
...
'pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','platform::actions.button','platform::actions.dropdown',
'platform::actions.link','platform::actions.menu','platform::actions.modal','platform::actions.toggle','platform::app',
'platform::auth','platform::auth.impersonation','platform::auth.lockme','platform::auth.login','platform::auth.signin',
'platform::components.notification','platform::components.popover','platform::components.stream','platform::dashboard','platform::dummy.block',
'platform::errors.404','platform::fields.attach','platform::fields.checkbox','platform::fields.code','platform::fields.cropper',
'platform::fields.dataRange','platform::fields.datetime','platform::fields.group','platform::fields.input','platform::fields.label',
'platform::fields.map','platform::fields.matrix','platform::fields.numberRange','platform::fields.password','platform::fields.picture',
'platform::fields.quill','platform::fields.radio','platform::fields.radiobutton','platform::fields.range','platform::fields.relation',
'platform::fields.select','platform::fields.simplemde','platform::fields.switch','platform::fields.textarea','platform::fields.upload',
'platform::fields.utm','platform::footer','platform::header','platform::layouts.accordion','platform::layouts.base',
'platform::layouts.blank','platform::layouts.block','platform::layouts.browsing','platform::layouts.card','platform::layouts.chart',
'platform::layouts.columns','platform::layouts.facepile','platform::layouts.filter','platform::layouts.legend','platform::layouts.listener',
'platform::layouts.metric','platform::layouts.modal','platform::layouts.pagination','platform::layouts.persona','platform::layouts.row',
'platform::layouts.selection','platform::layouts.sortable','platform::layouts.split','platform::layouts.tabMenu','platform::layouts.table',
'platform::layouts.tabs','platform::partials.alert','platform::partials.confirm','platform::partials.fields.clear','platform::partials.fields.horizontal',
'platform::partials.fields.matrixRow','platform::partials.fields.vertical','platform::partials.layouts.dt','platform::partials.layouts.filter','platform::partials.layouts.selectedTd',
'platform::partials.layouts.td','platform::partials.layouts.th','platform::partials.notification','platform::partials.notification-wrap','platform::partials.pagination',
